    ...
    <div className={styleClasses['login']}>
      <div className={styleClasses['login__wrapper']}>
        ...
        <div className={styleClasses['login__form']}>
          <CustomInput label="Email" name='email' placeholder='Email' errorMessage={emailErrorMessage} onChange={onInputChange} />
          <CustomInput label="Password" type='password' name='password' placeholder='Password' errorMessage={passwordErrorMessage} onChange={onInputChange} />
          <CustomButton title='Sign In' classNames={styleClasses['login__button']} type='primary' size='large' disabled={submitting} onClick={onLoginButtonClick} />
        </div>
      </div>
    </div>
  )
